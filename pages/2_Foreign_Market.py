...
st.set_page_config(page_title="Foreign Market Stock")
...
st.title("Stock's Portfolio Optimization in Foreign Market")
    ...
    for i in range(0,number_of_stock):
        ...
        if selected_stock == "":
            ...
            if df.empty:
                ...
                df.rename(columns={'Date': 'TradingDate'}, inplace=True)
